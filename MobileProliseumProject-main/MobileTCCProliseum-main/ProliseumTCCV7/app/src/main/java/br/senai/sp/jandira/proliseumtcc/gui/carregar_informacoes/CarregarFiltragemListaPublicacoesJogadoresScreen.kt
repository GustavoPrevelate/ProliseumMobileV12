...
import br.senai.sp.jandira.proliseumtcc.gui.editar_perfil.atualizarPostagem
...
@Composable
fun CarregarFiltragemListaPublicacoesJogadoresScreen(
                ...
                Column(
                    ...
                    Button(
                        onClick = {
                            ...
                            sharedFiltragemListaPostagensJogadores.funcao = selectedFuncaoLol?.toRepresentationStrinFuncao()
                            sharedFiltragemListaPostagensJogadores.elo = selectedEloLol?.toRepresentationStringEloLol()
                            sharedFiltragemListaPostagensJogadores.hora = selectedStartTimeString


                            onNavigate("carregar_filtragem_lista_publicacoes_jogadores_carregar")
